                        ...
                        <div class="card-body">
                            <form id="formProfileImageUpload" method="POST" action="{{ route('profile.uploadImage') }}" enctype="multipart/form-data">
                                ...
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img
                                        src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : 'https://placehold.co/100' }}"
                                        alt="user-avatar"
...
@push('scripts')
    <script>
        ...
        function resetImageDisplay() {
            document.getElementById('upload').value = '';
            document.getElementById('uploadedAvatar').src = '{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : 'https://placehold.co/100' }}';
        }
