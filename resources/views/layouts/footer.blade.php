        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-6 mb-4 pb-2">
                ...
                <ul class="site-footer-links">
                    ...
                    <li class="site-footer-link-item">
                        <a href="{{ route('map.index') }}" class="site-footer-link">Map</a>
                    </li>
                    <li class="site-footer-link-item">
                        <a href="{{ route('contact.index') }}" class="site-footer-link">Contact</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-12 mt-4 mt-lg-0 ms-auto">
                ...
                <p class="copyright-text mt-lg-5 mt-4">Copyright © 2024 SafePoint. All rights reserved.</p>
            </div>
        </div>
    </div>
</footer>
